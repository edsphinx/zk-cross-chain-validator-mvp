            ...
            <div className="space-y-8">
                        ...
                        <div className="w-10 h-10 relative flex-shrink-0">
                          <img
                            ...
                            onError={(e) => {
                              ...
                              e.currentTarget.parentElement!.className = 'text-3xl flex items-center justify-center w-10 h-10';
                            }}
                          />
                        </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <Link href="/proofs">
                    <div className="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-xl shadow-lg p-6 cursor-pointer hover:shadow-xl transition-shadow">
                      <div className="flex items-center space-x-3 mb-4">
                        ...
                        <h3 className="text-white font-semibold">ZK Proofs</h3>
                      </div>
